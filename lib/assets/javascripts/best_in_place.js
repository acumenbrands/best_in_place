...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.datatype      = self.datatype      || jQuery(this).attr("data-datatype");
    ...
    self.datatype      = self.element.attr("data-datatype")      || self.datatype;
...
BestInPlaceEditor.forms = {
  "input" : {
    activateForm : function() {
      var output = '<input type="text" name="'+ this.attributeName + '" value="' + this.sanitizeValue(this.display_value) + '"';
    ...
    keypressHandler : function(event) {
      if(event.keyCode == 9 || event.keyCode == 13) { // tab, enter
        ...
        event.data.editor.update();
        if(event.keyCode == 13) {
          // don't submit any form that we're inside
